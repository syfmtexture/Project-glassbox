...
export const evidenceApi = {
    ...
    getHighPriority: (caseId, params = {}) => apiClient.get(`/cases/${caseId}/evidence/high-priority`, { params }),
    ...
    update: (caseId, evidenceId, data) => apiClient.put(`/cases/${caseId}/evidence/${evidenceId}`, data),
    toggleBookmark: (caseId, evidenceId) => apiClient.post(`/cases/${caseId}/evidence/${evidenceId}/bookmark`),
    bulkUpdate: (caseId, ids, update) => apiClient.post(`/cases/${caseId}/evidence/bulk-update`, { ids, update }),
